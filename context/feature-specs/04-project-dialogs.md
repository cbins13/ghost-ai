...
Reuse the existing editor layout. Preserve the sidebar's current open, close, and navbar-toggle behavior while adding project actions and the mobile scrim dismissal.
